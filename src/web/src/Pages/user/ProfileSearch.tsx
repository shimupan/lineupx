    ...
    <div className="font-sans">
      ...
      <div className="flex gap-8 mb-8">
        <div className="bg-gray-900 p-6 rounded-lg shadow-md flex-1">
          ...
          <h3 className="text-gray-500 text-xl font-semibold mt-2">Radiant</h3>
        </div>
        <div className="bg-gray-900 p-6 rounded-lg shadow-md flex-1">
          <p className="text-sm">Overview</p>
          <h3 className="text-gray-500 text-xl font-semibold mt-2">Wins</h3>
        </div>
      </div>
      ...
      <div className="flex gap-8 mb-8">
        <div className="bg-gray-900 p-6 rounded-lg shadow-md flex-1">
          ...
          <h3 className="text-gray-500 text-xl font-semibold mt-2">Head</h3>
          <h3 className="text-gray-500 text-xl font-semibold mt-2">Body</h3>
          <h3 className="text-gray-500 text-xl font-semibold mt-2">Legs</h3>
        </div>
        <div className="bg-gray-900 p-6 rounded-lg shadow-md flex-1">
          <p className="text-sm">Top Agents</p>
          <h3 className="text-gray-500 text-xl font-semibold mt-2">Agent</h3>
        </div>
      </div>
