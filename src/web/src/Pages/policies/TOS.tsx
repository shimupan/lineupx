            ...
            <div className="flex flex-col min-h-screen items-center">
               <div className="flex-1 pt-16 px-8 text-white sm:pl-8 md:pl-64 lg:pl-64 text-sm md:text-base lg:text-lg max-w-6xl">
                  ...
                  <p>
                     ...
                     Welcome to www.lineupx.net/. LineupX (hereafter referred to
                     as “LineupX”, “we”, “us”, or “our”) provides a platform for
                     online courses (collectively, the “Services”), which
                     Services are accessible at www.lineupx.net/ and any other
                     websites through which LineupX makes the Services available
                     (collectively, the “Site”). The Site and Services are
                     offered to you conditioned on your acceptance without
                     modification of the terms, conditions, and notices
                     contained herein (the “Terms”). Your use of the Site and
                     Services constitutes your agreement to all such Terms.
                     Please read these terms carefully, and keep a copy of them
                     for your reference. We reserve the right to update or
                     modify these Terms at any time without prior notice to you,
                     and your continued use of the Site following LineupX’s
                     posting of any changes will constitute your acceptance of
                     such changes or modifications. We encourage you to review
                     these Terms whenever you use the Site.
                  </p>
                  <Section
                     title="Privacy"
