      ...
      <>
         ...
         <div className="flex flex-col min-h-screen items-center">
            <div className="flex-1 pt-16 px-8 text-white sm:pl-8 md:pl-64 lg:pl-64 text-sm md:text-base lg:text-lg max-w-6xl">
               ...
               <p>
                  LineupX operates the https://www.lineupx.net/ website, which
                  ...
                  our Service, the LineupX website. If you choose to use our
                  ...
                  at https://www.lineupx.net/, unless otherwise defined in this
                  Privacy Policy.
               </p>
               <Section
               ...
               <Section
                  ...
                  content={
                     <>
                        We run Google Ads on LineupX, by using our service you
                        agree to the Google Ads privacy policy and terms of
                        service which can be found{' '}
                        <a
               ...
               <Section
                  ...
                  content={
                     <>
                        To send emails to the users we use Nodemailer with the
                        Zoho Mail API. By signing up with an email account you
