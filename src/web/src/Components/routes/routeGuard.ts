...
export const ROUTE_CONFIG: Record<string, RouteConfig> = {
      ...
      validate: async (params) => {
         try {
            const response = await axios.get(
               `/post/detail/${params.game}/${params.id}`,
            );
   ...
   '/game/valorant/agents/:agentName/lineups': {
      validate: async (params) => {
         try {
            const response = await axios.get(
               `/game/valorant/agent/${params.agentName}`,
            );
            return !!response.data;
         } catch {
            return false;
   ...
   '/game/valorant/agents/:agentName/lineups/:mapName': {
      validate: async (params) => {
         try {
            const response = await axios.get(
               `/game/valorant/map/${params.mapName}`,
            );
            return !!response.data;
         } catch {
            return false;
   ...
   '/edit-post/:game/:id/:postId': {
      validate: async (params) => {
         try {
            const response = await axios.get(
               `/post/${params.game}/${params.postId}`,
            );
            return !!response.data;
         } catch {
            return false;
   ...
   '/search/:game/:query': {
      validate: async (params) => {
         try {
            const response = await axios.get(
               `/search/${params.game}/${params.query}`,
            );
